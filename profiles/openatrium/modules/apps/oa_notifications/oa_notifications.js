...
(function ($) {
  ...
  Drupal.behaviors.oaNotifications = {
    attach: function (context, settings) {
      ...
      $('body.page-node-add .pane-node-form-oa-notifications .remove-link a', context).once('oa-notify-processed', function () {
        $(this).on('click', function (e) {
          var parent = $(this).parent().parent('li');
          var removed = $('.pane-node-form-oa-notifications input.oa-notifications-remove', context);
